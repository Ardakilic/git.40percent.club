#PB-GHERKIN on a Raspberry Pi PICO
import board
...
gherkin.col_pins = (board.GP1, board.GP2, board.GP3, board.GP4, board.GP5, board.GP6)
gherkin.row_pins = (board.GP7, board.GP8, board.GP9, board.GP10, board.GP11)
